...
// Firestore data converter for BaseModel
export const BaseModelFirestoreConverter = {
toFirestore(modelObject: BaseModel): DocumentData {
...
fromFirestore(snapshot: QueryDocumentSnapshot, options: SnapshotOptions): BaseModel {
